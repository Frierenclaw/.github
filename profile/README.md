...
* **[Frieren Desktop](https://github.com/Frierenclaw/frieren-desktop) (The Face):** A window into another world. Real-time Electron desktop client that renders a 3D VRM avatar, streams microphone audio to Fern via LiveKit WebRTC, and animates the avatar in sync with the AI's voice using live viseme data.
