...
* **[Fern](https://github.com/Frierenclaw/heiter) (The Pipeline):** Strict and reliable `pipecat-ai` orchestrator. Handles real-time audio streams, VAD, and schedules animation frames.
...
`Python 3.14` • `Pipecat-ai` • `FastAPI` • `Tauri` • `Rust` • `Three.js` • `WebSockets`
